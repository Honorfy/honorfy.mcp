...
async function resolveCompanyId(
  ...
  const companies = await trpcGetJson<unknown>(
...
export function registerHonorfyTools(
  server: McpServer,
  deps: RegisterHonorfyToolsDeps,
): void {
    ...
    async (
      ...
      try {
        ...
        logStructured({
          ...
          message: "tool_error",
          extra:
            err instanceof HonorfyMcpError
  ...
  server.registerTool(
    ...
    run(
      "honorfy_list_companies",
      async (_args: z.infer<typeof listMyCompaniesInputSchema>) => {
        const ctx = trpcContextFromConfig(config, tokenProvider, undefined);
  ...
  server.registerTool(
    ...
    run(
      "honorfy_list_sales",
      async (args: z.infer<typeof listSalesInputSchema>) => {
  ...
  server.registerTool(
    ...
    run(
      "honorfy_get_sale",
      async (args: z.infer<typeof getSaleInputSchema>) => {
        const companyId = await resolveCompanyId(
          config,
          tokenProvider,
          args.companyId,
  ...
  server.registerTool(
    ...
    run(
      "honorfy_list_payments",
      async (args: z.infer<typeof listPaymentsInputSchema>) => {
        const companyId = await resolveCompanyId(
          config,
          tokenProvider,
          args.companyId,
  ...
  server.registerTool(
    "honorfy_get_payment",
    {
      ...
      description:
        "Localiza transação pelo id em páginas de `payment.wallet.listTransactions`.",
      inputSchema: getPaymentInputSchema,
    },
    run(
      "honorfy_get_payment",
      async (args: z.infer<typeof getPaymentInputSchema>) => {
        const companyId = await resolveCompanyId(
          config,
          tokenProvider,
          args.companyId,
  ...
  server.registerTool(
    ...
    run(
      "honorfy_list_incentives",
      async (args: z.infer<typeof listIncentivesInputSchema>) => {
        const companyId = await resolveCompanyId(
          config,
          tokenProvider,
          args.companyId,
  ...
  server.registerTool(
    ...
    run(
      "honorfy_get_incentive",
      async (args: z.infer<typeof getIncentiveInputSchema>) => {
        const companyId = await resolveCompanyId(
          config,
          tokenProvider,
          args.companyId,
  ...
  server.registerTool(
    ...
    run(
      "honorfy_list_incentive_groups",
      async (args: z.infer<typeof listIncentiveGroupsInputSchema>) => {
        const companyId = await resolveCompanyId(
          config,
          tokenProvider,
          args.companyId,
  ...
  server.registerTool(
    "honorfy_get_incentive_group",
    {
      ...
      description:
        "Busca grupo pelo id via páginas de `gamification.listIncentiveGroups`.",
      inputSchema: getIncentiveGroupInputSchema,
    },
    run(
      "honorfy_get_incentive_group",
      async (args: z.infer<typeof getIncentiveGroupInputSchema>) => {
        const companyId = await resolveCompanyId(
          config,
          tokenProvider,
          args.companyId,
  ...
  server.registerTool(
    "honorfy_list_group_participants",
    {
      ...
      description:
        "Lista participantes (`gamification.listParticipants`) filtrando por groupId.",
      inputSchema: listGroupParticipantsInputSchema,
    },
    run(
      "honorfy_list_group_participants",
      async (args: z.infer<typeof listGroupParticipantsInputSchema>) => {
        const companyId = await resolveCompanyId(
          config,
          tokenProvider,
          args.companyId,
  ...
  server.registerTool(
    "honorfy_capabilities",
    {
      ...
      description:
        "Lista tools disponíveis, versão e limites configurados (sem chamar a API).",
      inputSchema: emptyInputSchema,
    },
    run(
      "honorfy_capabilities",
      async (_args: z.infer<typeof emptyInputSchema>) => ({
